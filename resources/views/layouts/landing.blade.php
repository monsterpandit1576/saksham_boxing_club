                ...
                <div class="intro-contain">
                    <div>
                        <h1 class="wow fadeInLeft"
                            data-wow-duration="1s">{{__('FitHub - Gym Management Tool')}}</h1>
                        <p class="wow fadeInLeft"
                           data-wow-duration="1.5s">{{__('FitHub system is a software solution designed to streamline and automate the administrative and operational tasks involved in running a fitness center or gym.')}}</p>
                    ...
                    <div class="card ecom-product">
                        <div class="card-body p-10">
                            ...
                            <div class="detail-wrap">
                                <a href="#">
                                    <h5>{{__('Dashboard')}}</h5>
                                    <p>{{__('FitHub system is a software solution designed to streamline and automate the administrative and operational tasks involved in running a fitness center or gym.')}}</p>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xxl-3 cdx-xl-50 col-sm-6">
                    <div class="codex-pricingtbl">
                        ...
                        <ul class="cdxprice-list">
                            ...
                            <li><span> <i class="text-success mr-4" data-feather="check-circle"></i>{{$subscription->trainer_limit}}</span>{{__('Trainer Limit')}}</li>
                            <li><span> <i class="text-success mr-4" data-feather="check-circle"></i>{{$subscription->trainee_limit}}</span>{{__('Trainee Limit')}}</li>
                            <li>
