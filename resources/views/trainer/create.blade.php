{{Form::open(array('url'=>'trainers','method'=>'post'))}}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{Form::text('qualification',null,array('class'=>'form-control','placeholder'=>__('Enter qualification')))}}
        </div>
        <div class="form-group col-md-6">
            {{Form::label('assign_class',__('Classes'),array('class'=>'form-label')) }}
            {!! Form::select('assign_class[]', $classes, null,array('class' => 'form-control hidesearch basic-select','multiple')) !!}
        </div>
        <div class="form-group col-md-6">
