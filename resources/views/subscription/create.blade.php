...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group">
            {{Form::label('trainer_limit',__('Trainer Limit'),array('class'=>'form-label'))}}
            {{Form::number('trainer_limit',null,array('class'=>'form-control','placeholder'=>__('Enter trainer limit'),'required'=>'required'))}}
        </div>
        <div class="form-group">
            {{Form::label('trainee_limit',__('Trainee Limit'),array('class'=>'form-label'))}}
            {{Form::number('trainee_limit',null,array('class'=>'form-control','placeholder'=>__('Enter trainee limit'),'required'=>'required'))}}
        </div>
