            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            {{Form::label('trainer_number_prefix',__('Trainer Number Prefix'),array('class'=>'form-label')) }}
                            {{Form::text('trainer_number_prefix',$settings['trainer_number_prefix'],array('class'=>'form-control','placeholder'=>__('Enter trainer prefix')))}}
                        </div>
                        <div class="form-group col-md-6">
                            {{Form::label('trainee_number_prefix',__('Trainee Number Prefix'),array('class'=>'form-label')) }}
                            {{Form::text('trainee_number_prefix',$settings['trainee_number_prefix'],array('class'=>'form-control','placeholder'=>__('Enter trainee number prefix')))}}
                        </div>
                        <div class="form-group col-md-6">
