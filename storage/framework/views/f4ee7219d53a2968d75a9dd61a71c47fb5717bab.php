            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <?php echo e(Form::label('trainer_number_prefix',__('Trainer Number Prefix'),array('class'=>'form-label'))); ?>

                            <?php echo e(Form::text('trainer_number_prefix',$settings['trainer_number_prefix'],array('class'=>'form-control','placeholder'=>__('Enter trainer prefix')))); ?>

                        </div>
                        <div class="form-group col-md-6">
                            <?php echo e(Form::label('trainee_number_prefix',__('Trainee Number Prefix'),array('class'=>'form-label'))); ?>

                            <?php echo e(Form::text('trainee_number_prefix',$settings['trainee_number_prefix'],array('class'=>'form-control','placeholder'=>__('Enter trainee number prefix')))); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\saksham_boxing_club\resources\views/settings/company.blade.php ENDPATH**/ ?>