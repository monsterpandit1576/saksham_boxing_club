                ...
                <div class="intro-contain">
                    <div>
                        <h1 class="wow fadeInLeft"
                            data-wow-duration="1s"><?php echo e(__('FitHub - Gym Management Tool')); ?></h1>
                        <p class="wow fadeInLeft"
                           data-wow-duration="1.5s"><?php echo e(__('FitHub system is a software solution designed to streamline and automate the administrative and operational tasks involved in running a fitness center or gym.')); ?></p>
                        ...
                        <div class="card-body p-10">
                            ...
                            <div class="detail-wrap">
                                <a href="#">
                                    ...
                                    <p><?php echo e(__('FitHub system is a software solution designed to streamline and automate the administrative and operational tasks involved in running a fitness center or gym.')); ?></p>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xxl-3 cdx-xl-50 col-sm-6">
                    <div class="codex-pricingtbl">
                        ...
                        <ul class="cdxprice-list">
                            ...
                            <li><span> <i class="text-success mr-4" data-feather="check-circle"></i><?php echo e($subscription->trainer_limit); ?></span><?php echo e(__('Trainer Limit')); ?></li>
                            <li><span> <i class="text-success mr-4" data-feather="check-circle"></i><?php echo e($subscription->trainee_limit); ?></span><?php echo e(__('Trainee Limit')); ?></li>
                            <li>
                        ...
                        <a class="btn btn-primary" href="<?php echo e(route('register')); ?>"><?php echo e(__('Get Started')); ?> </a>
                    </div>
                </div>
        ...
        <div class="row cdx-row">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp">
                <div class="demo-grid">
                    ...
                    <div class="demo-detail">
                        <h3><?php echo e(__('User Role & Permission')); ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp">
                <div class="demo-grid">
                    ...
                    <div class="demo-detail">
                        <h3><?php echo e(__('Attendance')); ?></h3>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\saksham_boxing_clubs\resources\views/layouts/landing.blade.php ENDPATH**/ ?>