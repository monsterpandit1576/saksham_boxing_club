    ...
    <div class="codex-menuwrapper">
        <ul class="codex-menu custom-scroll" data-simplebar>
            ...
            <?php if(Gate::check('manage health trainer') || Gate::check('manage trainee') || Gate::check('manage health update') || Gate::check('manage workout') || Gate::check('manage today workout') || Gate::check('manage class') || Gate::check('manage membership') || Gate::check('manage attendance') || Gate::check('manage today attendance') || Gate::check('manage invoice') || Gate::check('manage expense')|| Gate::check('manage contact') || Gate::check('manage note')): ?>
                ...
                <?php if(Gate::check('manage trainee') || Gate::check('manage membership') || Gate::check('manage attendance') || Gate::check('manage invoice')  || Gate::check('manage health update')): ?>
                    <li class="menu-item <?php echo e(in_array($routeName,['trainees.index','membership.index','attendances.index','invoices.index','health-update.index'])?'active':''); ?>">
                        <a href="javascript:void(0);">
                            <div class="icon-item"><i data-feather="Trainee"></i></div>
                            <span><?php echo e(__('Trainee')); ?></span><i class="fa fa-angle-down"></i></a>
                        <ul class="submenu-list "
                            style="display: <?php echo e(in_array($routeName,['trainees.index','membership.index','attendances.index','invoices.index','health-update.index'])?'block':'none'); ?>">
                            <?php if(Gate::check('manage trainee')): ?>
                                <li class="<?php echo e(in_array($routeName,['trainees.index','trainees.show'])?'active':''); ?>">
                            ...
                            <?php if(Gate::check('manage membership')): ?>
                                <li class="<?php echo e(in_array($routeName,['membership.index','membership.show'])?'active':''); ?>">
                            ...
                            <?php if(Gate::check('manage attendance')): ?>
                                <li class="<?php echo e(in_array($routeName,['attendances.index'])?'active':''); ?>">
                                    <a href="<?php echo e(route('attendances.index')); ?>"><?php echo e(__('Members Attendance')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(Gate::check('manage invoice')): ?>
                                <li class="<?php echo e(in_array($routeName,['invoices.index','invoices.show'])?'active':''); ?>">
                                    <a href="<?php echo e(route('invoices.index')); ?>"><?php echo e(__('Members Invoice')); ?></a>
                                </li>
                            <?php endif; ?>
                            <?php if(Gate::check('manage health update')): ?>
                            <li class="<?php echo e(in_array($routeName,['health-update.index'])?'active':''); ?>">
                                <a href="<?php echo e(route('health-update.index')); ?>">
                                        <?php echo e(__('Member Health Fitness Card')); ?>
...
<!-- sidebar end-->
<?php /**PATH C:\xampp\htdocs\saksham_boxing_club\resources\views/admin/menu.blade.php ENDPATH**/ ?>