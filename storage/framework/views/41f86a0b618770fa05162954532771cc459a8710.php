...
<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <td class="table-user">
            <img
                src="<?php echo e(!empty($trainee->profile_picture) ? asset(Storage::url('upload/profile')).'/'.$trainee->profile_picture : asset(Storage::url('upload/profile')).'/avatar.png'); ?>"
                                        ...
                                        <div class="cart-action">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit trainee')): ?>
                                                <a class="text-success customModal" data-bs-toggle="tooltip"
                                                   ...
                                                   data-title="<?php echo e(__('Edit Trainee')); ?>"> <i class="fa fa-edit"></i></a>
                                            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\saksham_boxing_club\resources\views/trainee/index.blade.php ENDPATH**/ ?>