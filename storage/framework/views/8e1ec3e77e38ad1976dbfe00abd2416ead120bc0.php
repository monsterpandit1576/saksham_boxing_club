...
<?php $__env->startSection('card-action-btn'); ?>
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create invoice')): ?>
        <a class="btn btn-primary btn-sm ml-20" href="<?php echo e(route('invoices.create')); ?>"> <i
                    ...
                    <table class="display dataTable cell-border datatbl-advance">
                        ...
                        <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr role="row">
                                ...
                                <td><?php echo e(!empty($invoice->users)?$invoice->users->name:'-'); ?> </td>
                                <td><?php echo e(dateFormat($invoice->invoice_date)); ?> </td>
                                <td><?php echo e(dateFormat($invoice->invoice_due_date)); ?> </td>
                                <td><?php echo e(priceFormat($invoice->getInvoiceSubTotalAmount())); ?></td>
                                <td>
                                    <?php if($invoice->status=='unpaid'): ?>
                                        <span class="badge badge-danger"><?php echo e(\App\Models\Invoice::$status[$invoice->status]); ?></span>
                                ...
                                <?php if(Gate::check('edit invoice') || Gate::check('delete invoice') || Gate::check('show invoice')): ?>
                                    <td class="text-right">
                                        <div class="cart-action">
                                            <?php echo Form::open(['method' => 'DELETE', 'route' => ['invoices.destroy', $invoice->id]]); ?>

                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show invoice')): ?>
                                                <a class="text-warning" href="<?php echo e(route('invoices.show',\Illuminate\Support\Facades\Crypt::encrypt($invoice->id))); ?>"
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit invoice')): ?>
                                                <a class="text-success" href="<?php echo e(route('invoices.edit',\Illuminate\Support\Facades\Crypt::encrypt($invoice->id))); ?>"
                                                   data-bs-toggle="tooltip"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\saksham_boxing_clubs\resources\views/invoice/index.blade.php ENDPATH**/ ?>