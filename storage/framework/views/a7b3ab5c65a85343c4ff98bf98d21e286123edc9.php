    ...
    <div class="codex-authbox">
        <div class="auth-header">
            <div class="codex-brand">
                <a href="#">
                    <img class="img-fluid light-logo" width="70" src="<?php echo e(asset(Storage::url('upload/logo/')) . '/logo.png'); ?>"
                        alt="">
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\saksham_boxing_club\resources\views/auth/login.blade.php ENDPATH**/ ?>